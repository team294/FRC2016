...
//    	addSequential(new WaitSeconds(0.25));
    	...
    	addSequential(new DriveStraightDistance(.4, 42, DriveStraightDistance.Units.inches));    	// "Slow" speed, 42 inches.  This should get to the base of the defense
    	addSequential(new IntakeSetToSpeed(-1));
    	addSequential(new DriveStraightDistance(.4, 12, DriveStraightDistance.Units.inches));    	// "Slow" speed, this will push up against the port

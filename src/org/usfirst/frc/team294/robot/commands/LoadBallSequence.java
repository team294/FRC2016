...
public class LoadBallSequence extends CommandGroup {
    ...
    public  LoadBallSequence() {
    	...
    	addParallel(new FlyWheelSetToSpeed(-3000)); // Suck ball in if it is stuck on the arm (before moving the arm down)
...
//    	addSequential(new ShooterArmMoveToSetLocation(RobotMap.shooterArmBallLoadAngle), 0.75);  // Matt wants to do this manually, in case they need to suck ball in high they won't want to move the arm
